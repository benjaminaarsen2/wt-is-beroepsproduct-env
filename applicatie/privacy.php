...
<body>
    ...
    <main>
        ...
        <article>
            <p>Gelre airport, gevestigd aan Jan, is verantwoordelijk voor de verwerking van persoonsgegevens zoals
                weergegeven in deze privacyverklaring.
            <p>Contactgegevens:</p>

            <ul>
                <li>https://gelreairport.nl</li>
                <li>Jan</li>
                <li>+31 696969696</li>
            </ul>
            <p>Jan de man die alles kan is de Functionaris Gegevensbescherming van Gelre airport Hij/zij is te bereiken
                via jan@demandiealleskan.nl</p>
            <h3>Persoonsgegevens die wij verwerken</h3>

            <p>Gelre airport verwerkt geen persoonsgegevens omdat op onze site geen persoonsgegevens achter gelaten
                kunnen worden. Ook gebruiken we geen social media plugins.</p>
            ...
            <p>Onze website en/of dienst heeft niet de intentie gegevens te verzamelen over websitebezoekers die jonger
                ...
                verzameld over een minderjarige, neem dan contact met ons op via gelreairport@swag.nl, dan verwijderen
                wij deze informatie.</p>
            <h3>Met welk doel en op basis van welke grondslag wij persoonsgegevens verwerken</h3>

            <p>Gelre airport verwerkt uw persoonsgegevens voor de volgende doelen:</p>
            <ul>
            ...
            <p>Gelre airport neemt #responsibility op basis van geautomatiseerde verwerkingen besluiten over zaken die
                (aanzienlijke) gevolgen kunnen hebben voor personen. Het gaat hier om besluiten die worden genomen door
                computerprogramma's of -systemen, zonder dat daar een mens (bijvoorbeeld een medewerker van Gelre
                airport) tussen zit. Gelre airport gebruikt de volgende computerprogramma's of -systemen:
                #use_explanation</p>
            <h3>Hoe lang we persoonsgegevens bewaren</h3>

            <p>Gelre airport bewaart uw persoonsgegevens niet langer dan strikt nodig is om de doelen te realiseren
                waarvoor uw gegevens worden verzameld. Wij hanteren de volgende bewaartermijnen voor de volgende
                (categorieën) van persoonsgegevens: #retention_period</p>
            <h3>Delen van persoonsgegevens met derden</h3>

            <p>Gelre airport verstrekt uitsluitend aan derden en alleen als dit nodig is voor de uitvoering van onze
            ...
            <p>Gelre airport gebruikt geen cookies of vergelijkbare technieken.</p>
            <h3>Gegevens inzien, aanpassen of verwijderen</h3>

            <p>U heeft het recht om uw persoonsgegevens in te zien, te corrigeren of te verwijderen. Daarnaast heeft u
                het recht om uw eventuele toestemming voor de gegevensverwerking in te trekken of bezwaar te maken tegen
                de verwerking van uw persoonsgegevens door Gelre airport en heeft u het recht op
                ...
                persoonsgegevens sturen naar gelreairport@swag.nl. Om er zeker van te zijn dat het verzoek tot inzage
                ...
                snel mogelijk, maar binnen vier weken, op uw verzoek. Gelre airport wil u er tevens op wijzen dat u de
            ...
            <p>Gelre airport neemt de bescherming van uw gegevens serieus en neemt passende maatregelen om misbruik,
                ...
                contact op met onze klantenservice of via gelreairport@swag.nl</p>
        </article>
    </main>
